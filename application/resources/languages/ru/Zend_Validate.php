...
return array(
    ...
    // Zend_Validate_Regex
    "Invalid type given, value should be string, integer or float" => "Недопустимый тип данных, значение должно быть числом с плавающей точкой, строкой, или целым числом",
    "'%value%' does not match against pattern '%pattern%'" => "'%value%' использует недопустимые символы. Используйте 'a-zA-Z0-9'",
    ...
    // My
    "The two given tokens do not match"				=> "пароли не совпадают",
    "A record matching '%value%' was found"			=> "Логин '%value%' уже занят"
);
